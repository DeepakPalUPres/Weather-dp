...
const getWeather = async (city) => {
    ...
    try {
        const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=a5a7dfa7f5f678564373e2847cbc1bb7`, { mode: 'cors' })
...
window.addEventListener('load', () => {
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition((position) => {
            ...
            const api = `${proxy}api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=a5a7dfa7f5f678564373e2847cbc1bb7`
